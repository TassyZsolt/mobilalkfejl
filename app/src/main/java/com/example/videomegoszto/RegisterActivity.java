...
public class RegisterActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        accountTypeGroup.check(R.id.uploaderRadioButton);
    ...
    public void register(View view) {
        ...
        String passwordConfirmed = passwordConfirmEditText.getText().toString();
        ...
        Intent intent = new Intent(RegisterActivity.this, VideoListActivity.class);
